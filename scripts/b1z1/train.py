def train_b1z1(headless=True):
    ...
    from b1z1_gym.envs.wrappers.history_wrapper import HistoryWrapper
    ...
    # Overwriting num_actions from base value of 12
    ...
    # Add 24 for 6 more dof_pos + 6 dof_vel + 6 actions + 6 last_actions
    Cfg.env.num_observations = 70 + 24
